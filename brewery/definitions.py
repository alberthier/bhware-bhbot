...
LEFT_BUILDER_PLIERS_LEFT_HOLD    = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 602)
...
LEFT_BUILDER_PLIERS_RIGHT_HOLD   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_RIGHT, 413)
...
RIGHT_BUILDER_GRIPPER_LEFT_CLOSE   = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_LEFT, 621)
...
RIGHT_BUILDER_GRIPPER_RIGHT_CLOSE  = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_RIGHT, 420)
