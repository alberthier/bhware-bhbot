...
LEFT_BUILDER_PLIERS_RIGHT_HOLD   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT,  403) #TODO
...
LEFT_BUILDER_GRIPPER_LEFT_CLOSE   = makeServoMoveCommand((LEFT_BUILDER_GRIPPER_LEFT_ID,500), 621)
...
LEFT_BUILDER_GRIPPER_RIGHT_CLOSE   = makeServoMoveCommand((LEFT_BUILDER_GRIPPER_RIGHT_ID,500), 420)
