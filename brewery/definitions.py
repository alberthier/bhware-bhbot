...
LEFT_BUILDER_PLIERS_LEFT_CLOSE   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 587 + PLIERS_HOLD_ADJUSTEMENT_FACTOR)
LEFT_BUILDER_PLIERS_LEFT_HOLD    = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 620 + PLIERS_HOLD_ADJUSTEMENT_FACTOR, PLIERS_HOLD_TIMEOUT)
