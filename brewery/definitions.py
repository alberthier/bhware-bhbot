...
LEFT_BUILDER_PLIERS_LEFT_HOLD    = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 602, PLIERS_HOLD_TIMEOUT)
...
LEFT_BUILDER_PLIERS_RIGHT_HOLD   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_RIGHT, 413, PLIERS_HOLD_TIMEOUT)
