...
STORAGE_FINGER_RIGHT_HOLD    = makeServoMoveCommand(STORAGE_FINGER_RIGHT, 560)
STORAGE_FINGER_RIGHT_OPEN    = makeServoMoveCommand(STORAGE_FINGER_RIGHT, 490, SERVO_OPEN_TIMEOUT)
...
STORAGE_FINGER_RIGHT_FRONT_HOLD    = makeServoMoveCommand(STORAGE_FINGER_RIGHT_FRONT, 460)
STORAGE_FINGER_RIGHT_FRONT_OPEN    = makeServoMoveCommand(STORAGE_FINGER_RIGHT_FRONT, 544, SERVO_OPEN_TIMEOUT)
...
STORAGE_FINGER_LEFT_FRONT_HOLD    = makeServoMoveCommand(STORAGE_FINGER_LEFT_FRONT, 560)
STORAGE_FINGER_LEFT_FRONT_OPEN    = makeServoMoveCommand(STORAGE_FINGER_LEFT_FRONT, 490, SERVO_OPEN_TIMEOUT)

STORAGE_FINGER_LEFT         = (STORAGE_FINGER_LEFT_ID, 700)
STORAGE_FINGER_LEFT_INIT    = makeServoMoveCommand(STORAGE_FINGER_LEFT, 260)
STORAGE_FINGER_LEFT_HOLD    = makeServoMoveCommand(STORAGE_FINGER_LEFT, 460)
STORAGE_FINGER_LEFT_OPEN    = makeServoMoveCommand(STORAGE_FINGER_LEFT, 544, SERVO_OPEN_TIMEOUT)
...
ARM_7_HOLD    = makeServoMoveCommand(ARM_7, 505)
ARM_7_OPEN    = makeServoMoveCommand(ARM_7, 200, SERVO_OPEN_TIMEOUT)
