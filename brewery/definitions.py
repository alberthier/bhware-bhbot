...
LEFT_BUILDER_GRIPPER_LEFT_CLOSE   = makeServoMoveCommand((LEFT_BUILDER_GRIPPER_LEFT_ID, 350), 621)
...
LEFT_BUILDER_GRIPPER_RIGHT_CLOSE   = makeServoMoveCommand((LEFT_BUILDER_GRIPPER_RIGHT_ID, 350), 420)
LEFT_BUILDER_GRIPPER_RIGHT_GUIDE   = makeServoMoveCommand(LEFT_BUILDER_GRIPPER_RIGHT, 455)
LEFT_BUILDER_GRIPPER_RIGHT_LIGHT   = makeServoMoveCommand(LEFT_BUILDER_GRIPPER_RIGHT, 455)
...
RIGHT_BUILDER_GRIPPER_LEFT_INIT    = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_LEFT, 835)
RIGHT_BUILDER_GRIPPER_LEFT_CLOSE   = makeServoMoveCommand((RIGHT_BUILDER_GRIPPER_LEFT_ID, 350), 630)
RIGHT_BUILDER_GRIPPER_LEFT_GUIDE   = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_LEFT, 580)
RIGHT_BUILDER_GRIPPER_LEFT_LIGHT   = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_LEFT, 580)
RIGHT_BUILDER_GRIPPER_LEFT_DEPOSIT = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_LEFT, 490)

RIGHT_BUILDER_GRIPPER_RIGHT        = (RIGHT_BUILDER_GRIPPER_RIGHT_ID, 700)
RIGHT_BUILDER_GRIPPER_RIGHT_INIT   = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_RIGHT, 210)
RIGHT_BUILDER_GRIPPER_RIGHT_CLOSE  = makeServoMoveCommand((RIGHT_BUILDER_GRIPPER_RIGHT_ID, 350), 395)
RIGHT_BUILDER_GRIPPER_RIGHT_GUIDE  = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_RIGHT, 445)
RIGHT_BUILDER_GRIPPER_RIGHT_LIGHT  = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_RIGHT, 445)
RIGHT_BUILDER_GRIPPER_RIGHT_DEPOSIT= makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_RIGHT, 591)
