...
STAND_HOLD_ADJUSTEMENT_FACTOR = 15
...
LEFT_BUILDER_PLIERS_LEFT_CLOSE   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 602)
LEFT_BUILDER_PLIERS_LEFT_HOLD    = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 635, PLIERS_HOLD_TIMEOUT)
...
LEFT_BUILDER_PLIERS_RIGHT_CLOSE  = makeServoMoveCommand(LEFT_BUILDER_PLIERS_RIGHT, 400)
...
LEFT_BUILDER_GRIPPER_LEFT_CLOSE   = makeServoMoveCommand(LEFT_BUILDER_GRIPPER_LEFT, 636, GRIPPERS_HOLD_TIMEOUT)
...
LEFT_BUILDER_GRIPPER_RIGHT_CLOSE   = makeServoMoveCommand(LEFT_BUILDER_GRIPPER_RIGHT, 405, GRIPPERS_HOLD_TIMEOUT)
...
RIGHT_BUILDER_PLIERS_LEFT_CLOSE    = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_LEFT, 607)
RIGHT_BUILDER_PLIERS_LEFT_HOLD     = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_LEFT, 627, PLIERS_HOLD_TIMEOUT)
...
RIGHT_BUILDER_PLIERS_RIGHT_CLOSE   = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_RIGHT, 408)
RIGHT_BUILDER_PLIERS_RIGHT_HOLD    = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_RIGHT, 388, PLIERS_HOLD_TIMEOUT)
...
RIGHT_BUILDER_GRIPPER_LEFT_CLOSE   = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_LEFT, 636, GRIPPERS_HOLD_TIMEOUT)
...
RIGHT_BUILDER_GRIPPER_RIGHT_CLOSE  = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_RIGHT, 405, GRIPPERS_HOLD_TIMEOUT)
