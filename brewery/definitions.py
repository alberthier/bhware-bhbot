...
GRIPPERS_HOLD_TIMEOUT = 250
SERVO_OPEN_TIMEOUT = 500

STAND_HOLD_ADJUSTEMENT_FACTOR = 10
...
LEFT_BUILDER_PLIERS_LEFT_CLOSE   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 587 + STAND_HOLD_ADJUSTEMENT_FACTOR)
LEFT_BUILDER_PLIERS_LEFT_HOLD    = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 620 + STAND_HOLD_ADJUSTEMENT_FACTOR, PLIERS_HOLD_TIMEOUT)
...
LEFT_BUILDER_PLIERS_RIGHT_CLOSE  = makeServoMoveCommand(LEFT_BUILDER_PLIERS_RIGHT, 415 - STAND_HOLD_ADJUSTEMENT_FACTOR)
LEFT_BUILDER_PLIERS_RIGHT_HOLD   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_RIGHT, 395 - STAND_HOLD_ADJUSTEMENT_FACTOR, PLIERS_HOLD_TIMEOUT)
...
LEFT_BUILDER_GRIPPER_LEFT_CLOSE   = makeServoMoveCommand(LEFT_BUILDER_GRIPPER_LEFT, 621 + STAND_HOLD_ADJUSTEMENT_FACTOR, GRIPPERS_HOLD_TIMEOUT)
...
LEFT_BUILDER_GRIPPER_RIGHT_CLOSE   = makeServoMoveCommand(LEFT_BUILDER_GRIPPER_RIGHT, 420 - STAND_HOLD_ADJUSTEMENT_FACTOR , GRIPPERS_HOLD_TIMEOUT)
...
RIGHT_BUILDER_PLIERS_LEFT_CLOSE    = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_LEFT, 592 + STAND_HOLD_ADJUSTEMENT_FACTOR)
RIGHT_BUILDER_PLIERS_LEFT_HOLD     = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_LEFT, 612 + STAND_HOLD_ADJUSTEMENT_FACTOR, PLIERS_HOLD_TIMEOUT)
...
RIGHT_BUILDER_PLIERS_RIGHT_CLOSE   = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_RIGHT, 423 - STAND_HOLD_ADJUSTEMENT_FACTOR)
RIGHT_BUILDER_PLIERS_RIGHT_HOLD    = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_RIGHT, 403 - STAND_HOLD_ADJUSTEMENT_FACTOR, PLIERS_HOLD_TIMEOUT)
...
RIGHT_BUILDER_GRIPPER_LEFT_CLOSE   = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_LEFT, 621 + STAND_HOLD_ADJUSTEMENT_FACTOR, GRIPPERS_HOLD_TIMEOUT)
...
RIGHT_BUILDER_GRIPPER_RIGHT_CLOSE  = makeServoMoveCommand(RIGHT_BUILDER_GRIPPER_RIGHT, 420 - STAND_HOLD_ADJUSTEMENT_FACTOR, GRIPPERS_HOLD_TIMEOUT)
