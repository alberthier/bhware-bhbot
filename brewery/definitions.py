...
LEFT_BUILDER_PLIERS_LEFT_CLOSE   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 604)
LEFT_BUILDER_PLIERS_LEFT_HOLD    = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 614) #TODO
...
LEFT_BUILDER_PLIERS_RIGHT_HOLD   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_RIGHT, 403) #TODO
...
LEFT_BUILDER_GRIPPER_LEFT_INIT    = makeServoMoveCommand(LEFT_BUILDER_GRIPPER_LEFT, 808)
...
LEFT_BUILDER_GRIPPER_RIGHT_INIT    = makeServoMoveCommand(LEFT_BUILDER_GRIPPER_RIGHT, 211)
...
LIGHTER_GRIPPER       = (LIGHTER_GRIPPER_ID, 100)
...
CUP_GRIPPER_ON_CUP    = makeServoMoveCommand((CUP_GRIPPER_ID, 1000), 740)
