...
LEFT_BUILDER_PLIERS_RIGHT_CLOSE  = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 1234)
LEFT_BUILDER_PLIERS_RIGHT_OPEN   = makeServoMoveCommand(LEFT_BUILDER_PLIERS_LEFT, 1234)
...
RIGHT_BUILDER_PLIERS_RIGHT_CLOSE  = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_LEFT, 1234)
RIGHT_BUILDER_PLIERS_RIGHT_OPEN   = makeServoMoveCommand(RIGHT_BUILDER_PLIERS_LEFT, 1234)
