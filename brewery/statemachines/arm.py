...
class DropModuleFromStorage(State):
    def on_enter(self):
        if self.robot.team == TEAM_LEFT:
            yield ArmSpeed(250)
            arm_traj = [
            [[(1, 5), 437], [(1, 207), 298], [(1, 107), 350], [(0, 204), 745], [(0, 206), 443], [(0, 105), 540]],
            [[(1, 5), 383], [(1, 207), 330], [(1, 107), 389], [(0, 204), 793], [(0, 206), 524], [(0, 105), 540]],
            [[(1, 5), 261], [(1, 207), 507], [(1, 107), 562], [(0, 204), 722], [(0, 206), 653], [(0, 105), 450]],
            [[(1, 5), 284], [(1, 207), 573], [(1, 107), 596], [(0, 204), 714], [(0, 206), 637], [(0, 105), 450]],
            [[(1, 5), 460], [(1, 207), 437], [(1, 107), 435], [(0, 204), 835], [(0, 206), 492], [(0, 105), 450]],
            [[(1, 5), 512], [(1, 207), 466], [(1, 107), 465], [(0, 204), 870], [(0, 206), 456], [(0, 105), 450]],
            [[(1, 5), 497], [(1, 207), 449], [(1, 107), 489], [(0, 204), 850], [(0, 206), 459], [(0, 105), 450]]
            ]
            yield ReadArmTraj(arm_traj, delay=300)
            yield Timer(300)
            yield Trigger(ARM_7_OPEN)
            yield Timer(300)
            arm_traj = [
            [[(1, 5), 437], [(1, 207), 310], [(1, 107), 402], [(0, 204), 818], [(0, 206), 508], [(0, 105), 450]],
            [[(1, 5), 405], [(1, 207), 321], [(1, 107), 402], [(0, 204), 495], [(0, 206), 532], [(0, 105), 541]]
            ]
