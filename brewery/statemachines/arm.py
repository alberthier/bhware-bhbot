...
class DropModuleFromStorage(State):
    def on_enter(self):
        ...
        if self.robot.team == TEAM_RIGHT:
            yield ArmSpeed(250)
            arm_traj = [
            [[(1, 5), 412], [(1, 207), 305], [(1, 107), 414+30], [(0, 204), 173], [(0, 206), 497], [(0, 105), 513]],
            [[(1, 5), 594], [(1, 207), 463], [(1, 107), 535+30], [(0, 204), 244], [(0, 206), 624], [(0, 105), 520]],
            [[(1, 5), 632], [(1, 207), 612], [(1, 107), 704+30], [(0, 204), 251], [(0, 206), 666], [(0, 105), 588]],
            [[(1, 5), 610], [(1, 207), 662], [(1, 107), 757+30], [(0, 204), 255], [(0, 206), 658], [(0, 105), 619]],
            [[(1, 5), 553], [(1, 207), 550], [(1, 107), 608+30], [(0, 204), 248], [(0, 206), 619], [(0, 105), 607]],
            [[(1, 5), 459-15], [(1, 207), 508], [(1, 107), 561+30], [(0, 204), 213], [(0, 206), 540], [(0, 105), 622]],
            [[(1, 5), 430-15], [(1, 207), 503], [(1, 107), 563+30], [(0, 204), 171], [(0, 206), 472], [(0, 105), 629]]
            ]
            yield ReadArmTraj(arm_traj, delay=300)
            yield Timer(300)
            yield Trigger(ARM_7_OPEN)
            yield Timer(300)
            arm_traj = [
            [[(1, 5), 427], [(1, 207), 530], [(1, 107), 663+30], [(0, 204), 190], [(0, 206), 500], [(0, 105), 691]],
            [[(1, 5), 405], [(1, 207), 321], [(1, 107), 402 + 10], [(0, 204), 495], [(0, 206), 532], [(0, 105), 541]]
            ]
            yield ReadArmTraj(arm_traj, delay=300)
            yield Timer(300)
            ...
            arm_traj = [
            [[(1, 5), 593], [(1, 207), 371], [(1, 107), 486], [(0, 204), 827], [(0, 206), 384], [(0, 105), 0]],
            [[(1, 5), 632], [(1, 207), 657], [(1, 107), 752], [(0, 204), 843], [(0, 206), 343], [(0, 105), 0]],
            [[(1, 5), 606], [(1, 207), 711], [(1, 107), 764], [(0, 204), 887], [(0, 206), 364], [(0, 105), 0]],
            [[(1, 5), 530], [(1, 207), 544], [(1, 107), 560], [(0, 204), 872], [(0, 206), 442], [(0, 105), 0]],
            [[(1, 5), 457], [(1, 207), 507], [(1, 107), 508], [(0, 204), 828], [(0, 206), 497], [(0, 105), 0]],
            [[(1, 5), 460], [(1, 207), 439], [(1, 107), 486], [(0, 204), 828], [(0, 206), 490], [(0, 105), 0]]
            ]
            ...
            yield Timer(1000)
            arm_traj = [
            [[(1, 5), 459], [(1, 207), 436], [(1, 107), 529], [(0, 204), 827], [(0, 206), 490], [(0, 105), 0]]
            ]
            yield ReadArmTraj(arm_traj, delay=1000)
...
class InitForMonoColorModuleToDrop(State):
    def on_enter(self):
        # Init for test
        yield ArmSpeed(150+50)
        arm_traj = [
        # Init en test
        #[[(1, 5), 423], [(1, 207), 415], [(1, 107), 448+30], [(0, 204), 500], [(0, 206), 414], [(0, 105), 523]]
        [[(0, 206), 159] ],
        [[(1, 5), 430], [(1, 207), 470], [(1, 107), 389+30], [(0, 204), 510], [(0, 206), 320], [(0, 105), 512]],
        [[(1, 5), 429], [(1, 207), 492], [(1, 107), 521+30], [(0, 204), 510], [(0, 206), 466], [(0, 105), 515]],
...
class ClearFirstModule(State):
    def on_enter(self):
        ...
        if self.robot.team == TEAM_RIGHT:
            ...
            arm_traj = [
            [[(1, 5), 425], [(1, 207), 326], [(1, 107), 385 + 40], [(0, 204), 494], [(0, 206), 533], [(0, 105), 478]],
            [[(1, 5), 438], [(1, 207), 359], [(1, 107), 336 + 40], [(0, 204), 503], [(0, 206), 393], [(0, 105), 409]],
            [[(1, 5), 490], [(1, 207), 422], [(1, 107), 372 + 40], [(0, 204), 502], [(0, 206), 379], [(0, 105), 360]]
            ]
            yield ReadArmTraj(arm_traj, delay=150)
...
class DeposeFifthModule(State):
    def on_enter(self):
        ...
        [[(1, 5), 436], [(1, 207), 379], [(1, 107), 443 + 30-20-10], [(0, 204), 816], [(0, 206), 500], [(0, 105), 435]],
        ]
